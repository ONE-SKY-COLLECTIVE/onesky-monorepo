    ...
    const onboardingData = [
        {
          ...
          description: "One small step at a time, one person at a time. Collectively, we can make a difference.",
          buttonText: "Next",
        },
        {
          image: images.onboarding2,
          title: "Take action & earn rewards",
          description: "Walk, cycle, ditch plastic waste and make living sustainable a habit. Get rewarded for your efforts",
          buttonText: "Next",
        },
        {
  ...
  <SafeAreaView className="blue-bg-300" edges={["top"]}>
    ...
    <View className="blue-bg-300 entire-screen flex-v">
      ...
      <View className="h-[30vh] grow white-bg w-full rounded-tr-[36px] rounded-tl-[36px] p-10 flex-v items-cente absolute bottom-0">
        <Text className="text-[22px] my-3 font-semibold text-center">
          {currentStep.title}
        </Text>
        ...
        {onboardingProgress < 3 && (
          <TouchableOpacity onPress={() => router.push("../(homepage)")} className="w-full rounded-[8px]">
